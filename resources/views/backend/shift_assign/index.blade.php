        ...
        <div class="col-md-4">
            <div class="panel panel-default" data-collapsed="0">
                ...
                <div class="panel-body">
                    <form action="{{ route('assignshifts.store') }}" class="form-horizontal" method="post"
                            ...
                            <div class="col-sm-12">
                                <label class="control-label" style="display: block;">
                                    ...
                                    <div class="pull-right">
                                        <a href="{{ route('shift.index') }}" target="_blank">
                                            {{ __('New Shift') }}
										</a>
                                    </div>
                                ...
                                <select name="shift_id" class="form-control select2" required>
                                    <option value="">{{ _lang('Select One') }}</option>
                                    {{ create_option('shifts', 'id', 'name', old('shift_id')) }}
                                </select>
                            </div>
                        </div>
                        <div>
                        ...
                        <tbody>
                            @foreach ($assign_shifts as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('assignshifts.destroy', $data->id) }}" method="post">
                                            <a href="{{ route('assignshifts.edit', $data->id) }}"
