        ...
        <div class="col-md-12">
            <div class="panel panel-default" data-collapsed="0">
                <div class="panel-heading">
                    ...
                    <span class="panel-title">{{ _lang('Add New Book') }}</span>

                    <div class="pull-right" style="text-align: right;">
                        <a href="{{ route('books.bulk-upload') }}" class="btn btn-info btn-sm">{{ _lang('Bulk Upload') }}</a>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="col-md-8">
                        <form action="{{ route('books.store') }}" class="form-horizontal form-groups-bordered validate"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">{{ _lang('Code') }}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="rack_no" value="{{ old('rack_no') }}"
                                        required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">{{ _lang('Barcode') }}</label>
                                <div class="col-sm-9">
                                    <input type="file" class="form-control dropify" name="barcode"
                                        data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG">
                                </div>
                            </div>
