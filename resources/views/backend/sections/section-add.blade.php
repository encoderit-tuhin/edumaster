        ...
        <div class="col-md-4">
            <div class="panel panel-default" data-collapsed="0">
                ...
                <div class="panel-body">
                    <form action="{{ route('sections.store') }}" autocomplete="off"
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <select name="attendance_time_config_id" class="form-control select2" required>
                                    <option value="">Select One</option>
                                    {{ create_option('attendance_time_configs', 'id', 'shift', old('attendance_time_config_id')) }}
                                </select>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('sections.destroy', $data->id) }}" method="post">
                                            <a href="{{ route('sections.edit', $data->id) }}"
