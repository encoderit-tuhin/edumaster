        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('sections.update', $section->id) }}" autocomplete="off"
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <select name="attendance_time_config_id" class="form-control select2" required>
                                    <option value="">Select One</option>
                                    {{ create_option('attendance_time_configs', 'id', 'shift', $section->attendance_time_config_id) }}
                                </select>
                            </div>
                        </div>
                        ...
                        {{-- <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <input type="number" class="form-control" min="1" name="rank" required
                                    value="{{ $section->rank }}">
                            </div>
                        </div>
