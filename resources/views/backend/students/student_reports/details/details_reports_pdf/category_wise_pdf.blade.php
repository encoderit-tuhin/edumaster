 ...
 <head>
     ...
     <title>Student Lists - Category wise</title>
 ...
 <body style="width: 100%; margin: 0 auto; padding: 0;">
     ...
     @if (isset($categoryWiseStudents) && count($categoryWiseStudents) > 0)
         <table style="width: 100%; margin-bottom: 15px;">
             ...
             <tbody>
                 @forelse ($categoryWiseStudents as $student)
                     <tr style="padding: 15px 0 !important;">
                         <td>
                             {{ $student->id }}
                         </td>
             ...
             <tfoot style="background-color: #696969">
                 <tr>
                     ...
                     <td colspan="5" style="text-align:left; color: white;">{{ count($categoryWiseStudents) }}</td>
                 </tr>
             </tfoot>
         </table>
     @endif
