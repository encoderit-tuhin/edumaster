 ...
 <head>
     ...
     <title>Student Lists - Section Category wise </title>
 ...
 <body style="width: 100%; margin: 0 auto; padding: 0;">
     ...
     <table
         ...
         <tr>
             @php
                 ...
                 $categoryName = App\StudentCategory::where('id', $category_id)
                     ->select('id', 'name')
                     ->first();
             @endphp
             ...
             <td style="border: 1px solid black; font-weight: 700">{{ $categoryName->name }}</td>
         </tr>
     </table>
     ...
     @if (isset($sectionCategoryWiseStudents) && count($sectionCategoryWiseStudents) > 0)
         <table style="width: 100%; margin-bottom: 15px;">
             ...
             <tbody>
                 @forelse ($sectionCategoryWiseStudents as $student)
                     <tr style="padding: 15px 0 !important;">
                         <td>
                             {{ $student->id }}
                         </td>
             ...
             <tfoot style="background-color: #696969">
                 <tr>
                     <td colspan="5" style="text-align:right; color: white;">{{ _lang('Total') }}</td>
                     <td colspan="5" style="text-align:left; color: white;">
                         {{ count($sectionCategoryWiseStudents) }}</td>
                 </tr>
             </tfoot>
         </table>
     @endif
