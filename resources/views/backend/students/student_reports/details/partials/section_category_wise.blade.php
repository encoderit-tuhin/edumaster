 <div class="panel panel-default">
     <div class="panel-body">
         <div class="row justify-content-center">
             <div class="col-lg-8">
                 <form class="" method="post" action="{{ route('section-category-wise-student-list.search') }}"
                     autocomplete="off" accept-charset="utf-8">
                     @csrf

                     <input type="hidden" name="form_type" value="section_category_wise">
             ...
             <div class="col-lg-12">
                 <div class="panel-body">
                     @if (isset($sectionCategoryWiseStudents) && count($sectionCategoryWiseStudents) > 0)
                         ...
                         @if (isset($sectionId) && isset($categoryId))
