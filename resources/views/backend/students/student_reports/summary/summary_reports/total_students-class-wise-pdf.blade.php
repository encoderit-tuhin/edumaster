...
<head>
    ...
    <title>Total Students info class-wise</title>
...
<body style="width: 100%; margin: 0 auto; padding: 0;">
    ...
    <table
        ...
        <tr>
            ...
            <td style="border: 1px solid black; font-weight: 700">Class Wise</td>
        </tr>
    </table>
    ...
    @if (isset($classWiseData) && count($classWiseData) > 0)
        <table style="width: 100%; margin-bottom: 15px;">
            ...
            <tfoot style="background-color: #696969">
                <tr>
                    <td style="text-align:right;">{{ _lang('Total') }}</td>
                    <td style="text-align:left;">{{ $totalStudentCount }}</td>
                </tr>
            </tfoot>
        </table>
    @endif
