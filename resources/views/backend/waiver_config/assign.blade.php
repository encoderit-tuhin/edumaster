 ...
 <div class="panel panel-default">
     <div class="panel-heading">
        <span class="panel-title">{{ _lang('Fee Mapping') }}</span>
    </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="">
                                     <select name="group" id="group" class="form-control select2">
                                         {{ create_option('student_groups', 'id', 'group_name', isset($request->group) ?? $request->group) }}
                                     </select>
                                 </div>
                             </div>
                         </div>
                             ...
                             <table class="table table-bordered">
                                 ...
                                 <tbody>
                                     @foreach ($students as $key => $student)
                                         <tr>
                                            <th scope="row">
                                                <input type="checkbox" class="waiver-checkbox" value="{{ $student->id  }}" name="students[{{$key}}]">
                                            </th>
                                            <th scope="row">{{ $student->id }}  </th>
                                            <td>{{ $student->roll }}<input type="number" hidden value="{{ $student->roll }}" name="roll_no[{{$key }}]"></td>
                                            <td>{{ $student->name }} <input type="text" hidden value="{{$student->name}}" name="students_name[{{$key}}]"></td>
