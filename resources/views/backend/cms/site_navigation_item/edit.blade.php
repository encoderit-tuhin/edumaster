            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <form action="{{ action('NavigationItemController@destroy', $id) }}" method="post">
                        ...
                        <button style="margin-top:-28px;" class="btn btn-danger pull-right btn-remove"
                    ...
                    <form method="post" autocomplete="off" action="{{ action('NavigationItemController@update', $id) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="menu_label"
                                    value="{{ $navigationitem->menu_label }}" required>
                            </div>
                        </div>
                                ...
                                <select class="form-control select2" name="page_id">
                                    ...
                                    @foreach ($pages as $page)
                                        <option value="{{ $page->id }}"
                                            {{ $navigationitem->page_id == $page->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="parent_id">
                                    <option value="">{{ _lang('Select One') }}</option>
                                    {{ create_option('site_navigation_items', 'id', 'menu_label', $navigationitem->parent_id, ['id !=' => $navigationitem->id, 'AND IFNULL(parent_id,0) !=' => $navigationitem->id, 'AND navigation_id=' => $navigationitem->navigation_id]) }}
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="css_class"
                                    value="{{ $navigationitem->css_class }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="css_id"
                                    value="{{ $navigationitem->css_id }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="" control-label for="exampleCheck1">{{ _lang('Deactive') }}</label>
                           
                                <input type="checkbox" {{ $navigationitem->status == 0 ? 'checked' : '' }}
                                    class="form-check-input" id="exampleCheck1" name="status" value="1">
                        </div>
