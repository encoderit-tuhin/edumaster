            ...
            <div class="panel panel-default" data-collapsed="0">
                ...
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-primary btn-sm" href="{{ route('students.attendance-bulk-upload') }}">
                ...
                <div class="panel-body">
                    <form id="search_form" class="params-panel validate" action="{{ url('student/attendance') }}"
                        ...
                        <div class="col-md-12" id="attendance">
                            <div class="panel-heading text-center">
                                <div class="panel-title">
                                    ...
                                    {{ _lang('Period') . ' ' . $periodName }} <br>
                                    {{ date('d-M-Y', strtotime($date)) }}<br>
                                </div>
                            </div>
                            <form action="{{ url('student/attendance/save') }}" class="appsvan-submit-validate"
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        ...
                                        <th>{{ _lang('Roll') }}</th>
                                        <th>
                                            <label class="c-container">{{ _lang('Present') }}<input type="checkbox"
                                                    id="present_all" onclick="present(this)"><span class="checkmark">
                                                </span></label>
                                        </th>
                                        <th>
                                            <label class="c-container">{{ _lang('Absent') }}<input type="checkbox"
                                                    id="absent_all" onclick="absent(this)"><span class="checkmark">
                                                </span></label>
                                        </th>
                                        {{-- <th>
                                            <label class="c-container">{{ _lang('Late') }}<input type="checkbox"
                                                    id="late_all" onclick="late(this)"><span class="checkmark">
                                                </span></label>
                                        </th>
                                        <th>
                                            <label class="c-container">{{ _lang('Holiday') }}<input type="checkbox"
                                                    id="holiday_all" onclick="holiday(this)"><span class="checkmark">
                                                </span></label>
                                        </th> --}}
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="c-container">
                                                        <input type="checkbox" name="attendance[{{ $key }}][]"
                                                ...
                                                <td><label class="c-container"><input type="checkbox"
                                                            ...
                                                            class="absent"><span class="checkmark"></span></label></td>

                                                {{-- <td><label class="c-container"><input type="checkbox"
                                                            name="attendance[{{ $key }}][]"
                                                            @if ($data->attendance == '3') checked @endif value="3"
                                                            class="late"><span class="checkmark"></span></label></td>
                                                <td><label class="c-container"><input type="checkbox"
                                                            name="attendance[{{ $key }}][]"
