            ...
            <div class="panel panel-default" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title pull-left">
                        {{ _lang('Students Attendance Bulk Upload') }}
                    </div>
                    <div class="pull-right">
                        <a class="btn btn-primary btn-sm" href="{{ url('student/attendance') }}">
                            <i class="fa fa-upload"></i>
                            {{ _lang('Take Attendance') }}
                        </a>
                    </div>
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        ...
                        <form action="{{ route('students.attendance-bulk-upload.store') }}" autocomplete="off"
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default text-center">
                            ...
                            <div class="panel-body" style="margin: 30px 0;">
                                <a href="{{ route('students.attendance-download.demo.file') }}">
