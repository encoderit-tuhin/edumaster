        ...
        <form action="{{ route('student-migration.store') }}" class="validate" autocomplete="off" method="post"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6 student-section ">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Select Subject') }}</label>
                                    <select name="subject_id" onchange="get_students();" id="subject_id" required
            ...
            {{-- </div><div class="col-md-12 mt-5">
                <div class="container ">
                    ...
                    <button type="button" class="btn btn-success  float-right" data-toggle="modal" id='modal-show-button' style="display: none"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="col-md-12 student-section ">
                                        <div class="form-group">
                                            <label
                                                class="control-label">{{ _lang('Select Section') }}</label>
                                            <select name="section_id" 
                                                id="section_id" required class="form-control select2">
                                                <option value="">{{ _lang('Select One') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <button type="submit"
                                        class="btn btn-primary">{{ _lang('Submit') }}</button>
...
@section('js-script')
    <script type="text/javascript">
        ...
        function get_students() {
            ...
            var link = "{{ url('mark-input/section-wise') }}" + exam_id + subject_id;
