...
<div class="panel panel-default">
    <div class="panel-heading"><span class="panel-title">{{ _lang('Class Wise') }}</span></div>
...
@endphp
            <div class="col-lg-12">
                <form action="{{route('merit-list.show')}}" method="POST" class="" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <select name="class" id="class" class="form-control select2">
                                        {{ create_option('classes', 'id', 'class_name', isset($request->class) ?? $request->class) }}
                                    </select>
                                </div>
                            </div>
                        </div>
