            ...
            @if (!empty($exams))
                <div class="panel panel-default" id="progress_card">
                    <div class="panel-heading">
                        ...
                        <button type="button" data-print="progress_card" class="btn btn-primary btn-sm pull-right print"><i
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <td colspan="4" style="text-align:center;"><img width="100px"
                                        ...
                                        src="{{ asset('uploads/images/' . $student->image) }}"></td>
                            </tr>
                            <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered report-card">
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($exams as $exam)
                                            <th colspan="{{ count($mark_head) }}"
                                                style="background:#bdc3c7;text-align:center"><b>{{ $exam->name }}</b>
                                            </th>
                                        @endforeach
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td colspan="100%" style="text-align:center">
                                            <h5>{!! _lang('Average Marks') . ' : <b>' . number_format($total / $total_subject, 2) . '</b>' !!}</h5>
                                        </td>
                                    </tr>
            ...
            @foreach ($exams as $exam)
                <div class="panel panel-default" id="exam_{{ $exam->exam_id }}">
                    <div class="panel-heading">
                        ...
                        <button type="button" data-print="exam_{{ $exam->exam_id }}"
                            class="btn btn-primary btn-sm pull-right print"><i class="fa fa-print"></i>
                            {{ _lang('Print') . ' ' . $exam->name . ' ' . _lang('Only') }}</button>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
                            <tr>
                                <td colspan="2" style="text-align:center;"><img width="100px"
                                        style="border-radius: 8px; padding:5px; border:2px solid #ccc;"
                                        src="{{ asset('uploads/images/' . $student->image) }}"></td>
                            </tr>
                            <tr>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                @foreach ($subjects as $subject)
                                    ...
                                    @php
                                        if ($subject->pass_mark > $row_total) {
                                            $fail = true;
                                        }
                                    @endphp
                                @endforeach
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        {{ _lang('Avg Grade') . ' ' . decimalPlace($total_point / $total_subject) }}</td>
                                ...
                                <tr>
                                    <td colspan="100%">
                                        @if ($fail == true)
                                            <div class="alert alert-danger">
                                                <h5>{{ _lang('Final Grade') . ' ' . _lang('FAIL') }}</h5>
                                            </div>
                                        @else
                                            <div class="alert alert-success">
                                                <h5>{{ _lang('Final Grade') . ' ' . get_final_grade($total_point / $total_subject) }}
                                                </h5>
                                            </div>
                                        @endif
                                    </td>
