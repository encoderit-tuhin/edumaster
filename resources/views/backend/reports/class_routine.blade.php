        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="search_form" class="params-panel validate" action="{{ url('reports/class_routine/view') }}"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <button type="submit" style="margin-top:24px;"
                                    class="btn btn-primary btn-block rect-btn">{{ _lang('View Routine') }}</button>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default" data-collapsed="0">
                                <div class="panel-heading">
                                    ...
                                    <button type="button" data-print="classic_routine"
                                    ...
                                    <div class="col-md-12">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab"
                                                    href="#modern">{{ _lang('Accordion View') }}</a></li>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="100" class="text-center">
                                                                <span
                                                                    class="f-20">{{ get_option('school_name') }}</span></br>
                                                                <span
                                                                    class="f-18">{{ _lang('Class Routine') }}</span></br>
                                                                <span class="f-18">{{ _lang('Class') }}:
