        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="search_form" class="params-panel validate" action="{{ url('reports/exam_report/view') }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="exam_id" required>
                                    ...
                                    {{ create_option('exams', 'id', 'name', $exam_id, ['session_id=' => get_option('academic_year')]) }}
                                </select>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                {{ _lang('Avg Grade') . ' ' . decimalPlace($total_point / $total_subject) }}
                                            </td>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    jQuery.each(json, function(i, val) {
                        $('select[name=student_id]').append("<option value='" + val['id'] + "'>Roll " +
