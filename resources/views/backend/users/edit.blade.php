        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-8">
                        <form action="{{ route('users.update', $data->id) }}" autocomplete="off"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="user_type" class="form-control select2" required>
                                        ...
                                        <option @if ($data->user_type == 'Admin') selected @endif value="Admin">
                                            {{ _lang('Admin') }}</option>
                                        <option @if ($data->user_type == 'Accountant') selected @endif value="Accountant">
                                            {{ _lang('Accountant') }}</option>
                                        <option @if ($data->user_type == 'Librarian') selected @endif value="Librarian">
                                            {{ _lang('Librarian') }}</option>
                                        <option @if ($data->user_type == 'Employee') selected @endif value="Employee">
                                            {{ _lang('Employee') }}</option>
                                        <option @if ($data->user_type == 'Teacher') selected @endif value="Teacher">
                                            {{ _lang('Teacher') }}</option>
                                        <option @if ($data->user_type == 'Staff') selected @endif value="Staff">
                                            {{ _lang('Staff') }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">{{ _lang('Assign Roles') }}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control dropify" name="image"
                                        data-default-file="{{ asset('uploads/images/' . $data->image) }}"
