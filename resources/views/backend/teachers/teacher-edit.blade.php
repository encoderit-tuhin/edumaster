                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control datepicker"
                                                            name="birthday" value="{{ $teacher->birthday }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <select name="blood" class="form-control niceselect wide">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" name="mother_name"
                                                            value="{{ $teacher->mother_name }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <textarea class="form-control" name="permanent_address" required>{{ $teacher->permanent_address }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
