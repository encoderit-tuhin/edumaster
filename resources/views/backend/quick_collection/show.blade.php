...
@section('content')
                                ...
                                <div class="col-md-6">
                                    <div class="card text-center border-danger">
                                        ...
                                        <div class="card-body py-5">
                                            <p class="card-text" id="attendance_fine_print">
                                                {{ format_currency(0) }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="attendance_fine" id="attendance_fine_value" />
                                ...
                                <div class="col-md-6">
                                    <div class="card text-center border-warning">
                                        ...
                                        <div class="card-body py-5">
                                            ...
                                            <p class="card-text" id="total_paid_print">
                                                {{ format_currency(0) }}
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card text-center border-success">
                                        ...
                                        <div class="card-body py-5">
                                            ...
                                            <p class="card-text" id="total_payable_print">
                                                {{ format_currency(0) }}
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card text-center border-info">
                                        ...
                                        <div class="card-body py-5">
                                            ...
                                            <p class="card-text" id="total_due_print">
                                                {{ format_currency(0) }}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="absent"
                                            onchange="getAbsentAmount(this.value)" required>
                                            <option value="0">Select</option>
                                            @foreach ($attendence as $row)
                                                @php $month = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']; @endphp
                                                <option value="{{ $row->absent }}">
    ...
    <!-- Modal -->
    <div class="modal fade" id="exampleModal" tabindex="-500" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
@section('scripts')
    <script>
        ...
        function getFeeAmount(subHeadId, feeHeadId) {
            var selectElements = $(".sub_head_ids");
            var allSubHeadIds = [];
            selectElements.each(function(index, selectElement) {
                ...
                allSubHeadIds = allSubHeadIds.concat(subHeadIds);
            });
            $.ajax({
                url: "{{ route('student-collection.sub-head-wise-calculation') }}",
                type: "POST",
                data: {
                    fee_sub_head_ids: allSubHeadIds,
                ...
                success: function(response) {
                    ...
                    $("#fee_and_fine_payable_" + feeHeadId).val(
                        response.fee_and_fine_payable
                    );
                    $("#previous_due_payable_" + feeHeadId).val(
                        response.previous_due_payable
                    );
        ...
        function getSummaryAmount() {
            ...
            var attendance_fine = $("#attendance_fine_value").val();
            if (attendance_fine) {
                totalPaid = totalPaid + parseFloat(attendance_fine);
                totalPayable = totalPayable + parseFloat(attendance_fine);
            }
        ...
        function getAbsentAmount(value) {
            var fine = value * "{{ intval($absentFine->fee_amount) }}";
            $("#attendance_fine_print").html("৳" + fine);
            $("#attendance_fine_value").val(fine);
