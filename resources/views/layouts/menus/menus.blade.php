...
<li>
    ...
    <ul class="new">
        @if (has_permission('students.index', Auth::User()->role_id))
            <li @if (Request::is('students') or
                    Request::is('students/create') or
                    Request::is('students/edit') or
                    Request::is('students-bulk-upload')) class="active" @endif>
...
<li>
    ...
    <ul>
        ...
        @if (has_permission('book-categories.index', Auth::User()->role_id))
...
<li>
    ...
    <ul>
        ...
        @if (has_permission('academic-years.index', Auth::User()->role_id))
