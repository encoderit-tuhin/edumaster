    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-tabs setting-tab">
                ...
                <li class=""><a data-toggle="tab" href="#slider" aria-expanded="true">{{ _lang('Content Slider') }}</a>
                </li>
                <li class=""><a data-toggle="tab" href="#social"
                        aria-expanded="true">{{ _lang('Social And Contact') }}</a></li>
                <li class=""><a data-toggle="tab" href="#custom_css"
                        aria-expanded="false">{{ _lang('Custom CSS') }}</a></li>
                <li class=""><a data-toggle="tab" href="#custom_js" aria-expanded="false">{{ _lang('Custom JS') }}</a>
                </li>
            </ul>
            <div class="tab-content">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="post" class="appsvan-submit params-panel" autocomplete="off"
                                action="{{ url('administration/theme_option/update') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                        ...
                                        <select class="form-control select2" name="home_page">
                                            ...
                                            @foreach (get_pages() as $page)
                                                <option value="{{ $page->id }}"
                                                    {{ $page->id == get_option('home_page') ? 'selected' : '' }}>
                                                    {{ $page->content[0]->page_title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control dropify" name="hero_image"
                                            data-max-file-size="8M" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"
                                            data-default-file="{{ get_option('hero_image') != '' ? asset('uploads/media/' . get_option('hero_image')) : '' }}">
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="post" class="appsvan-submit params-panel" autocomplete="off"
                                action="{{ url('administration/theme_option/update') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <button type="button" id="add_slide"
                                    class="btn btn-info rect-btn">{{ _lang('Add New Slide') }} + </button>
                                <p>&nbsp;</p>
                                ...
                                @if (empty($slider))
                                    <div class="well repeat">
                                        <button type="button"
                                            class="remove-row btn btn-danger btn-sm pull-right">{{ _lang('Remove') }}</button>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">{{ _lang('Slider Heading') }}</label>
                                                <input type="text" class="form-control" name="slider[slider_heading][]"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="slider[slider_content][]"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="well {{ $i == 0 ? 'repeat' : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $slider['slider_heading'][$i] }}"
                                                        name="slider[slider_heading][]" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">{{ _lang('Slider Content') }}</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $slider['slider_content'][$i] }}"
                                                        name="slider[slider_content][]" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">{{ _lang('Button Link') }}</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $slider['button_link'][$i] }}"
                                                        name="slider[button_link][]">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">{{ _lang('Button Text') }}</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $slider['button_text'][$i] }}"
                                                        name="slider[button_text][]">
                                                </div>
                                            </div>
                                        </div>
                                    @endfor
                ...
                <div id="social" class="tab-pane">
                    <div class="panel panel-default">
                        <div class="panel-heading"><span class="panel-title">{{ _lang('Social And Contact') }}</span>
                        </div>
                            ...
                            <form method="post" class="appsvan-submit params-panel" autocomplete="off"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="google_map_api"
                                            value="{{ get_option('google_map_api') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="google_map_latitude"
                                            value="{{ get_option('google_map_latitude') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="google_map_longitude"
                                            value="{{ get_option('google_map_longitude') }}">
                                    </div>
                                </div>
