        ...
        <div class="cover">
            <div class="container">
                <div class="header_content">
                    <h2>{{__("Departmental Teacher Information")}}</h2>
                    <ul>
                        <li><a href="{{route('index')}}">{{__("Home")}}</a></li>
                        <li>{{__("Departmental Teacher")}}</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                @foreach ($departments as $department)
                    <div class="col-lg-3 col-md-4 col-6">
                        <a href="{{ route('teacher-department', $department->slug) }}" class="department_box">
                            <h4>{{__("Department of")}}</h4>
                            <h5>{{__( $department->department_name) }}</h5>
                        </a>
                    </div>
                @endforeach
            </div>
