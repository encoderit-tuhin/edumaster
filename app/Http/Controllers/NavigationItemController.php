...
class NavigationItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->ajax()) {
            return redirect('site_navigation_items/navigation/' . $navigationitem->navigation_id)->with('success', _lang('Saved Successfully'));
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        $navigationitem->css_class = $request->input('css_class');
        $navigationitem->css_id = $request->input('css_id');
        $navigationitem->status = $request->status ? 0 : 1;
    ...
    public function destroy($id)
    {
        ...
        return redirect('site_navigation_items/navigation/' . $navigationitem->navigation_id)->with('success', _lang('Deleted Successfully'));
    }
}
