...
class HscRecommendationController extends Controller
{
    ...
    {
        return view('backend.hsc_recommendation.index', [
    ...
    {
        return view('backend.hsc_recommendation.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        // dd($request->roll);
        return view('backend.hsc_recommendation.recommendation-format', compact('testimonial'));
    ...
    public function show($id)
    {
        ...
        return view('backend.hsc_recommendation.show', compact('testimonial'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.hsc_recommendation.edit', compact('testimonial', 'boardsName'));
    }
    ...
    public function update(TestimonialRequest $request, $id)
    {
        ...
        return redirect()->route('hsc-recommendation.index')
    ...
    public function studentSearch(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return view('backend.hsc_recommendation.search-student', compact('student', 'boardsName'));
        }
    }
    public function testimonialPdf($id)
    {
        ...
        // return $data;
        $pdf = PDF::loadView('backend.hsc_recommendation.testimonial-format', $data);
