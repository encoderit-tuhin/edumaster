...
class SpecificFeeController extends Controller
{
    ...
    {
        return view('backend.specific_fee.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        //     return view('backend.specific_fee.index', ['feeMap' => $feeMap, 'feeMapFeeSubHeads' => $feeMapFeeSubHeads]);
        // } else {
