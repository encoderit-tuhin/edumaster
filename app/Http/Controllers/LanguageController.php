...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('languages')->with('success', _lang('Language Created Successfully'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (fwrite($file, $contents)) {
            return redirect('languages')->with('success', _lang('Updated Successfully'));
        } else {
    ...
    public function destroy($id)
    {
        if (file_exists(resource_path() . "/language/$id.php")) {
            ...
            return redirect('languages')->with('success', _lang('Removed Successfully'));
        }
    }
}
