...
class GeneralCertificateController extends Controller
{
    ...
    {
        return view('backend.general_certificate.index', [
    ...
    {
        return view('backend.general_certificate.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('backend.general_certificate.general-format', compact('testimonial'));
    ...
    public function show($id)
    {
        ...
        return view('backend.general_certificate.show', compact('testimonial'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.general_certificate.edit', compact('testimonial', 'boardsName'));
    }
    ...
    public function update(TestimonialRequest $request, $id)
    {
        ...
        return redirect()->route('general-certificate.index')
    ...
    public function studentSearch(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return view('backend.general_certificate.search-student', compact('student', 'boardsName'));
        }
    }
    public function testimonialPdf($id)
    {
        ...
        // return $data;
        $pdf = PDF::loadView('backend.general_certificate.general-format', $data);
